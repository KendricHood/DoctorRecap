...
#THIS CODE WAS NOT WRITTEN BY KENDRIC HOOD OR ANY OTHER EMPLYEE OF EXPLORYS AN IBM COMPANY
#this code as been lightly modified by Kendric Hood
#This code is not intended for production use reviewed and approved by Explorys an IBM company


# Author: Daniel Bolanos (original Author)
# Date:   2015
...
class Utils:   
   ...
   def getAuthenticationToken():
         ...
         r = requests.get(url, auth=(userName,password), verify=False, headers= {'Accept': 'application/json'},timeout= (30, 30))
         return r
